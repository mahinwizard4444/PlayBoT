...
async def about(bot, update):
    await update.reply_photo(
            ...
            caption='എനിക്ക് പ്രേത്യേകിച്ച് about,കഴിവ് ഒന്നും ഇല്ല..എന്റെ മുതലാളി ആണ് എന്റെ എല്ലാം (Jack SIR) Just മുതലാളി പറയും ഞാൻ അത് അനുസരിക്കും.. അനുസരിച്ചാൽ എനിക്ക് bun കിട്ടും.. 😌'
    )
